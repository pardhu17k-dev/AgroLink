...
final List<FoodItem> mockFoodItems = [
  ...
  FoodItem(
    id: '6',
    title: 'Surplus Fresh Broccoli',
    description:
        'Extra harvest of organic broccoli heads from local urban gardens. Completely free for community food banks, families in need, and local shelters.',
    price: 0.0,
    originalPrice: 140.0,
    farmerName: 'Green Valley Farm',
    farmerAvatar: 'GV',
  ...
  FoodItem(
    id: '7',
    title: 'Community Crisp Cucumbers',
    description:
        'Crisp and refreshing organic cucumbers donated by Community Garden Project. High water content, great for fresh salads and juices.',
    price: 0.0,
    originalPrice: 60.0,
    farmerName: 'Happy Earth Farm',
    farmerAvatar: 'HE',
    ...
    quantity: 35,
    unit: 'kg',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Cucumis_sativus_jpg.jpg',
    isDonation: true,
    expiryDate: '5 days',
  ...
  FoodItem(
    id: '8',
    title: 'Farm-Fresh Red Bell Peppers',
    description:
        'Vibrant, sweet, and crunchy red bell peppers harvested at peak ripeness. Packed with Vitamin C and grown without synthetic pesticides.',
    price: 129.0,
    originalPrice: 160.0,
    farmerName: 'Metro Greenhouses',
    farmerAvatar: 'MG',
    ...
    quantity: 25,
    unit: 'kg',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5c/Capsicum_annuum_Group_002.JPG',
    isDonation: false,
    expiryDate: '6 days',
